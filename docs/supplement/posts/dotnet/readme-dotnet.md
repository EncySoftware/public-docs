...
The CAM system has two independent postprocessing subsystems; both are actual and can be used by your choice. This section documents only the .NET based system. The other subsystem (the Postprocessors generator) is documented under [Postprocessors generator](../sppx/readme-sppx.md).
