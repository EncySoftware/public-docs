...
To find the exact name of a property: open the operation's **property inspector**, locate the property, click the **...** button at the right of its row and choose **"Copy property name to clipboard"**; or inspect the operation's XML. The naming rules and the full access model are described in [Using XML properties from code](../../../../xml-customization/src/xml-properties/using-from-code.md).
...
- [Using XML properties from code](../../../../xml-customization/src/xml-properties/using-from-code.md)
