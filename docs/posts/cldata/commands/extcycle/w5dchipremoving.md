# EXTCYCLE W5DChipRemoving - Drilling with chip removing cycle (G83)
...
| CLD[2] | CLD.SubType | Canned cycle type identifier: W5DChipRemoving(483). |
...
| CLD[17] | CLD.CLParams(15) | St, chip removing step value |
| CLD[18] | CLD.CLParams(16) | Dg, each iteration chip removing step degression |
