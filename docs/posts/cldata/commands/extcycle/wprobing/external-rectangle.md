...
1. The tool moves the distance specified in the `Feed distance` and approaches the starting position of the cycle. The movement is executed at "Approach feed";
...
7. Steps 2-6 are repeated 3 more times for each touch points;
...
|---|---|---|
| CmdPrm.Int[-1] | Integer | Probing cycle type: External rectangle probing value = 8 |
