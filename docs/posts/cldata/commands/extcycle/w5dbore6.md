# EXTCYCLE W5DBore6 - Drilling cycle (G86)

Boring cycle `W5DBore6(486)` (G86) performs tool approach to the hole center, hole boring with stop at minimum level and rapid retract to the **Return** level.

![G86](../../../sppx/src/images/download/attachments/142669187/G86.PNG)
...
| CLD[2] | CLD.SubType | Canned cycle type identifier: W5DBore6(486) (G86). |
...
![W5DSchema](../../../sppx/src/images/download/attachments/142669187/W5DSchema.png)
