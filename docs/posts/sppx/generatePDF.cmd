...
echo.
echo Generate offline PDF for the sppx postprocessing documentation
...
COPY /Y _pdf\pdf\toc.pdf "_pdf\Postprocessing-sppx.pdf" >nul

echo.
echo Done. Review file: _pdf\Postprocessing-sppx.pdf
pause
