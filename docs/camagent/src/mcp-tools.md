...
The agent drives the CAM system through **161 tools** grouped by area. You normally do not
...
| **Operations** | cam_create_operation, cam_move_operation, cam_delete_operation, cam_select_operation, cam_set_params, cam_get_params, cam_set_safe_level, cam_list_operation_types, cam_reset_toolpath, cam_reset_simulation |
...
| **Tools** | cam_list_tools, cam_list_library_tools, cam_add_tool, cam_assign_tool, cam_get_tool_properties, cam_set_tool_properties |
...
| **Simulation panel** | cam_simulation_goto_error, cam_simulation_get_current_frame, cam_simulation_read_frames, cam_simulate_to_current_frame, cam_get_tool_position |
...
| **Kinematics** | cam_compute_workpiece_matrix |
| **Utilities** | cam_list_utilities, cam_run_utility |
| **Feeds & speeds** | cam_list_feeds_speeds, cam_query_feeds_speeds, cam_calculate_mrr_toollife, cam_estimate_cycle_time, cam_collect_operation_times |
...
| **AI skills** | skill_search, skill_get, skill_list, skill_update, skill_upload, user_skill_add, user_skill_delete, user_skill_list, user_skill_import |
...
| **Health** | cam_ping, cam_is_alive, cam_operator_activity, rag_ping |
